...
# package_deps.sh
# 
# Purpose: Given a target package, this script scans your LOCAL environment to:
#          1. List what the package requires (Forward Dependencies)
#          2. List what installed packages require IT (Reverse Dependencies)
# 
# Usage:   ./scripts/package_deps.sh <package_name>
# Example: ./scripts/package_deps.sh protobuf
# ============================================================================
